...
// Utility: Day of week calculation (em português, para consistência com o resto da UI)
...
return `Tiferet te convida hoje para: ${theme}. Não como conceito abstrato, mas como presença corporal no seu peito. O que está acontecendo em você agora?`;
}
};
...
personal: `Para você, Diego, esta qualidade ${dayOfWeek === 'Domingo' ? 'de repouso' : dayOfWeek === 'Sábado' ? 'de integração' : 'de movimento'} traz um espelho.`,
mirror: 'O que sua energia cósmica está te pedindo para soltar hoje?'
},
numerology: {
